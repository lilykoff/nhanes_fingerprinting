...
if(!file.exists(here::here("data", "lily", "data", "grid_cell_data_temporal", outname)) | force){
  grid_data_list =
  ...
  readr::write_csv(grid_data_df, here::here("data", "lily", "data", "grid_cell_data_temporal", outname))
