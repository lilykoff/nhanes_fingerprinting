...
if(!dir.exists(here::here("data", "lily", "data", "fingerprint_res", "test_not_train"))){
  dir.create(here::here("data", "lily", "data", "fingerprint_res", "test_not_train"),
             recursive = TRUE)
}
...
if(!file.exists(here::here("data", "lily", "data", "fingerprint_res", "train_not_test", paste0("fold_", ifold, "_1000.rds"))) | force){
  ...
  saveRDS(res, here::here("data", "lily", "data", "fingerprint_res", "test_not_train", fname))
}
