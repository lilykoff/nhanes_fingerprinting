...
Rnosave 04_regress_on_covars.R -J REGRESSF3 --mem=90G --cpus-per-task=8 --ntasks=1 -o eofiles/%x_%A.out -e eofiles/%x_%A.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu


Rnosave 04_regress_on_covars.R -J REGRESSF3 --mem=120G --time=30-00 -o eofiles/%x_%A.out -e eofiles/%x_%A.err
...
Rnosave 05_run_fingerprints_all_folds.R -J INDIVID --mem=30G --array=2-1000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds.R -J INDIVID --mem=30G --array=1001-2000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds.R -J INDIVID --mem=30G --array=2001-3000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds.R -J INDIVID --mem=30G --array=3001-4000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds.R -J INDIVID --mem=30G --array=4001-5000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds.R -J INDIVID --mem=30G --array=5001-6000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds.R -J INDIVID --mem=30G --array=6001-7000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds.R -J INDIVID --mem=30G --array=7001-8000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds.R -J INDIVID --mem=30G --array=8001-9000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds.R -J INDIVID --mem=30G --array=9001-10000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds_x.R -J INDIVID --mem=30G --array=1-1000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds_x.R -J INDIVID --mem=30G --array=1001-2000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds_x.R -J INDIVID --mem=30G --array=2001-3000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_all_folds_x.R -J INDIVID --mem=30G --array=3001-3367 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
...
Rnosave 05_run_fingerprints_generic_large.R -J FPALLFIN --export=INPUT=13367 --mem=100G --array=26,74,77,78 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
...
Rnosave 05_run_fingerprints_generic_large_xgb2.R -J XBG500TEST --export=INPUT=500 --mem=50G --array=1 --cpus-per-task=8 --ntasks=1 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
Rnosave 05_run_fingerprints_generic_large_xgb2.R -J XGB500 --export=INPUT=500 --mem=30G --array=1-1000 --cpus-per-task=8 --ntasks=1 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
Rnosave 05_run_fingerprints_generic_large_temporal_xgb2.R -J XGBT500 --export=INPUT=500 --mem=30G --array=1-1000 --cpus-per-task=8 --ntasks=1 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu

Rnosave 05_run_fingerprints_generic_large_xgb2.R -J XGB5000 --export=INPUT=5000 --mem=40G --array=1-1000 --cpus-per-task=8 --ntasks=1 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
Rnosave 05_run_fingerprints_generic_large_temporal_xgb2.R -J XGBT5000 --export=INPUT=5000 --mem=40G --array=1-1000 --cpus-per-task=8 --ntasks=1 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu





Rnosave 05_run_fingerprints_generic_xgb.R -J XGB500 --export=INPUT=500 --mem=50G --array=1-26 --cpus-per-task=8 --ntasks=1 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
Rnosave 05_run_fingerprints_generic_temporal_xgb.R -J XGBT500 --export=INPUT=500 --mem=50G --array=1-26 --cpus-per-task=8 --ntasks=1 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu

Rnosave 05_run_fingerprints_generic_xgb.R -J XGB1000 --export=INPUT=1000 --mem=50G --array=1-13 --cpus-per-task=8 --ntasks=1 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
Rnosave 05_run_fingerprints_generic_temporal_xgb.R -J XGBT1000 --export=INPUT=1000 --mem=50G --array=1-11 --cpus-per-task=8 --ntasks=1 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu

Rnosave 05_run_fingerprints_generic_large_temporal_xgb.R -J XGB10000T --export=INPUT=10000 --mem=20G --cpus-per-task=8 --ntasks=1 --array=1-1000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_generic_large_xgb.R -J XGB10000 --export=INPUT=10000 --mem=20G --cpus-per-task=8 --ntasks=1 --array=1-1000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err

Rnosave 05_run_fingerprints_generic_large_over.R -J PCT10000T --export=INPUT=10000 --mem=30G --array=1-1000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave 05_run_fingerprints_generic_large_temporal_over.R -J PCT10000T --export=INPUT=10000 --mem=30G --array=1-1000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err


# run these 2 script next
Rnosave 05_run_fingerprints_generic_tnt.R -J TNT100 --export=INPUT=100 --mem=35G --array=1-133 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
...
Rnosave 05_run_fingerprints_generic_pctov_tmp.R -J PCT100T --export=INPUT=100 --mem=35G --array=1-133 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu


Rnosave 05_run_fingerprints_generic_temporal_rf.R -J RFT100 --export=INPUT=100 --mem=40G --array=1-112 --cpus-per-task=8 --ntasks=1 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
Rnosave 05_run_fingerprints_generic_rf.R -J RF100 --export=INPUT=100 --mem=40G --array=1-133 --cpus-per-task=8 --ntasks=1 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
...
Rnosave 06_summarize_preds_all.R -J SUMMPA --mem=60G --time=30-00 -o eofiles/%x_%A.out -e eofiles/%x_%A.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
Rnosave 06_summpa2.R -J SUMMPA2 --mem=100G --time=30-00 --cpus-per-task=8 --ntasks=1 -o eofiles/%x_%A.out -e eofiles/%x_%A.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu

Rnosave process_pct.R -J PCTPROC --mem=30G --time=30-00 -o eofiles/%x_%A.out -e eofiles/%x_%A.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
...
Rnosave 06_fit_sofr_temporal.R -J TSOFR100 --export=INPUT=100 --mem=60G --array=1-112 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu

Rnosave 06_fit_sofr.R -J SOFR500 --export=INPUT=500 --mem=60G --array=1-1000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
Rnosave 06_fit_sofr_temporal.R -J TSOFR500 --export=INPUT=500 --mem=60G --array=1-1000 --time=30-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
