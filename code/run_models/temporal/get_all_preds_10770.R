...
if(!dir.exists(here::here("data", "lily", "data", "preds_10770"))){
  dir.create(here::here("data", "lily", "data", "preds_10770"), recursive = TRUE)
}
for(id in ids){
  print(id)
  file = file.path(here::here("data", "lily", "data", "fingerprint_res_temporal2", "10770", paste(id, ".rds", sep = "")))

  outfile = file.path(here::here("data", "lily", "data", "preds_10770", paste0(id, ".rds")))
