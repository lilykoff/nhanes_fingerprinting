...
Rnosave run_temporal_xgb_large.R -J XGB500T --export=INPUT=500 --mem=30G --array=1 --cpus-per-task=8 --ntasks=1 --time=10-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
...
# long sensitivity analysis
Rnosave run_temporal_long.R -J FPL100T --export=INPUT=100 --mem=40G --array=1-80 --time=3-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave run_temporal_long.R -J FPL1000T --export=INPUT=100 --mem=40G --array=1-8 --time=3-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err

Rnosave run_temporal_long_large.R -J FP2500LT --export=INPUT=2500 --mem=20G --array=1-1000 --time=3-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave run_temporal_long_large.R -J FP5000LT --export=INPUT=5000 --mem=30G --array=1-1000 --time=3-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
Rnosave run_temporal_long_large.R -J FP10000LT --export=INPUT=8018 --mem=40G --array=1-1000 --time=3-00 -o eofiles/%x_%A_%a.out -e eofiles/%x_%A_%a.err
...
Rnosave logistic_random.R -J SUMM_LOG_R --mem=50G --time=3-00 -o eofiles/%x_%A.out -e eofiles/%x_%A.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
...
Rnosave xgb_rf.R -J SUMM_ML --mem=50G --time=3-00 -o eofiles/%x_%A.out -e eofiles/%x_%A.err --mail-type=FAIL,END --mail-user=lkoffma2@jh.edu
