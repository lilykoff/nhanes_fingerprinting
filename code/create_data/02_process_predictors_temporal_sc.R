...
readr::write_csv(all_preds, here::here("data", "lily", "data", "all_grid_cells_temporal_sc.csv.gz"))
...
saveRDS(filename_df, here::here("data", "lily", "data", "fingerprint_folds_temporal_sc.rds"))
