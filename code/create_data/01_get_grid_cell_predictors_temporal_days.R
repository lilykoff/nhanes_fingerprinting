...
if(!dir.exists(here::here("data", "lily", "data", "grid_cell_data_temporal_days"))){
  dir.create(here::here("data", "lily", "data", "grid_cell_data_temporal_days"))
}
...
get_density = function(subject, df = df){
  ...
  x = try({
    ...
    test =
      ...
      select(id, day, second, data, starts_with("("), starts_with("["))
...
if(!file.exists(here::here("data", "lily", "data", "grid_cell_data_temporal_days", outname)) || force){
  grid_data_list =
  ...
  readr::write_csv(grid_data_df, here::here("data", "lily", "data", "grid_cell_data_temporal_days", outname))
