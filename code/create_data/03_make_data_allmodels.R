...
outfiles = c(here::here("data", "lily", "data", "dat_nzv_train_scs.rds"),
             here::here("data", "lily", "data", "dat_nzv_test_scs.rds"))

if(!all(file.exists(outfiles))) {
  xdf = readr::read_csv(here::here("data", "lily", "data", "all_grid_cells_sc_small.csv.gz"))
  # xdf = readr::read_csv(here::here("data", "lily", "data", "sample_grid_cells.csv.gz"))
  xdf = xdf %>% filter(id %in% filenames$id)
  set.seed(123)
  initialsplit = initial_split(xdf, prop = 3/4, strata = id)
...
outfiles = c(here::here("data", "lily", "data", "dat_nzv_train_long.rds"),
             here::here("data", "lily", "data", "dat_nzv_test_long.rds"))
...
for(s in sizes){
  ...
  folds = filenames %>%
    ...
    filter(n == s)
  for(f in folds$fold){
    outfiles = c(here::here("data", "lily", "data", paste0("dat_nzv_train_long", s, "_", f, ".rds")),
                 here::here("data", "lily", "data", paste0("dat_nzv_test_long", s, "_", f, ".rds")))
    if(!all(file.exists(outfiles))){
      ids = filenames %>% filter(fold == f) %>% pull(id)
      xdf_temp = xdf %>% filter(id %in% ids)
      set.seed(123)
...
# temporal 2
outfiles = c(here::here("data", "lily", "data", "dat_nzv_train_temporal2.rds"),
             here::here("data", "lily", "data", "dat_nzv_test_temporal2.rds"))
...
for(s in sizes){
  ...
  folds = filenames %>%
    ...
    filter(n == s)
  for(f in folds$fold){
    outfiles = c(here::here("data", "lily", "data", paste0("dat_nzv_train_temporal2_", s, "_", f, ".rds")),
                 here::here("data", "lily", "data", paste0("dat_nzv_test_temporal2_", s, "_", f, ".rds")))
    if(!all(file.exists(outfiles))){
      print(outfiles[1])
...
outfiles = c(here::here("data", "lily", "data", "dat_nzv_train_long_temporal.rds"),
             here::here("data", "lily", "data", "dat_nzv_test_long_temporal.rds"))
filenames = readRDS(here::here("data", "lily", "data", "fingerprint_folds_long_temporal.rds"))

if(!all(file.exists(outfiles))) {
  xdf = readr::read_csv(here::here("data", "lily", "data", "all_grid_cells_long_temporal.csv.gz"))
  # xdf = readr::read_csv(here::here("data", "lily", "data", "sample_grid_cells_temporal.csv.gz"))
...
for(s in sizes){
  ...
  folds = filenames %>%
    ...
    filter(n == s)
  for(f in folds$fold){
    outfiles = c(here::here("data", "lily", "data", paste0("dat_nzv_train_long_temporal_", s, "_", f, ".rds")),
                 here::here("data", "lily", "data", paste0("dat_nzv_test_long_temporal_", s, "_", f, ".rds")))
    if(!all(file.exists(outfiles))){
      print(outfiles[1])
      ids = filenames %>% filter(fold == f) %>% pull(id)
      xdf_temp = xdf %>% filter(id %in% ids)
