...
if(size < 500){
  ...
  outfile1 = here::here("data", "lily", "data", "fingerprint_res_temporal2", paste0(size, "fnl"), paste0("fold_", ifold, ".rds"))
  outfile2 = here::here("data", "lily", "data", "fingerprint_res_temporal2", paste0(size, "nlfnl"), paste0("fold_", ifold, ".rds"))
  ...
  for(f in folds$fold){
    ...
    for(id in ids){
      ...
      i = i + 1
      outfile1 = here::here("data", "lily", "data", "fingerprint_res_temporal2", paste0(size, "fnl"), paste0(id, ".rds"))
      outfile2 = here::here("data", "lily", "data", "fingerprint_res_temporal2", paste0(size, "nlfnl"), paste0(id, ".rds"))
      dir1 = dirname(outfile1)
      dir2 = dirname(outfile2)
      if(!dir.exists(dir1)){
        dir.create(dir1, recursive = TRUE)
      ...
      df = readr::read_csv(here::here("data", "lily", "data", "all_grid_cells_temporal2.csv.gz")) %>%
